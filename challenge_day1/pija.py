...
def act2():
    return "Inside the tower, the wooden stairs creaked under thier weight, each step echoeing through the emptie halls. Lila’s flashlight flickered, casting spooky shaps on the walls. Marcus mumbled about old hauntings, making Jace scff loudly."

def act3():
    return "Back on the tower’s balcomy, the town stretched out below them, lights twinkeling like stars. Lila realized the clocktower wasn’t just a building; it was a gaurdian of hidden knowlege. Jace grumbled, “All I see is a high plase to get blown off."